...
1. Eseguire sempre le spec: 'bundle exec rspec'
...
persono la loro utilità
4. Se una spec fallisce c'è qualche problema: controlla il perchè

#@jtodoIMP create doc for usage of the classes